...
#      and the rotation amount angle (in degrees)
    ...
    a=math.cos(xform[2]/180*math.pi)
    b=-math.sin(xform[2]/180*math.pi)
    c=math.sin(xform[2]/180*math.pi)
    d=math.cos(xform[2]/180*math.pi)
...
def lab1c(xform1,xform2):
    ...
    Out:
     ...
     """
   # rad1=math.pi*xform1[2]/180
   # rad2=math.pi*xform2[2]/180
    angle=(xform1[2]+xform2[2])%360
   # rotation=klampt.so2.matrix(rad2)
    tx=xform2[0]*math.cos(xform1[2]/180*math.pi)-xform2[1]*math.sin(xform1[2]/180*math.pi)+xform1[0]
    ty=xform2[0]*math.sin(xform1[2]/180*math.pi)+xform2[1]*math.cos(xform1[2]/180*math.pi)+xform1[1]
    xform2=(tx,ty,angle)
